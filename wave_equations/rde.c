...
#define YMIN -2.041666667
#define YMAX 2.041666667	/* y interval for 9/16 aspect ratio */
...
#define FORCE_FIELD 0       /* type of force field, see list in global_3d.c  */
...
#define VISCOSITY_MAX 2.0        /* max value of viscosity beyond which NVID is increased and integration step is decrased*/
...
#define IN_OUT_FLOW_AMP 0.7	/* amplitude of in-flow/out-flow boundary conditions (for Euler equation) - max value */
...
#define ROTATE_ANGLE 0.0  /* total angle of rotation during simulation */
...
//#define FLOODING_VSHIFT 1    /* controls when wave is considered higher than land */
#define FLOODING_VSHIFT_2D 1    /* controls when wave is considered higher than land */
...
#define PRINT_LEFT 0            /* set to 1 to print parameters at left side */
...
#define COLOR_PALETTE_B 5     /* Color palette, see list in global_pdes.c  */
...
#define NXMAZE 14      /* width of maze */
#define NYMAZE 14 	/* height of maze */
